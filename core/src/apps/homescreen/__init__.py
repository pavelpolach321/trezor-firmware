...
async def demo_setup_wallet() -> None:
    ...
    from trezor.ui.layouts.reset import show_intro_backup, show_warning_backup
...
async def demo_send_bitcoin() -> None:
    ...
    await confirm_total(
        total_amount="0.05000555 BTC",
        fee_amount=fee,
        title="Summary",
        total_label="Total amount",
        fee_label="incl. Transaction fee",
        source_account=source_account,
        source_account_path=source_account_path,
